...
class ReaderTrainer(object):
    ...
    def __init__(self, args):
        ...
        #tokenizer = tfs.AutoTokenizer.from_pretrained(args.pretrained_model_cfg)
        #codingan wawat
        tokenizer = tfs.LongformerTokenizerFast.from_pretrained(
